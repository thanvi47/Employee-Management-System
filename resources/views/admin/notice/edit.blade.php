        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
             ...
             @csrf
                    @method('PUT')
                    <div class="card">
                    <div class="card-header">{{ __('Edit Notice') }}
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" value="{{$notice->description}}">
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                        <strong>   <div class="alert alert-danger">
                                   {{$message}}
